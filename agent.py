...
class Agent:
    ...
    def get_state(self,game):
        ...
        state=[
            ...
            (dir_d and game.is_collision(point_d)) or (dir_u and game.is_collision(point_u)),

            (dir_u and game.is_collision(point_r)) or (dir_d and game.is_collision(point_l)) or
            (dir_r and game.is_collision(point_d)) or (dir_l and game.is_collision(point_u)),
            
            (dir_d and game.is_collision(point_r)) or (dir_u and game.is_collision(point_l)) or
            (dir_l and game.is_collision(point_d)) or (dir_r and game.is_collision(point_u)),
...
def train():
    ...
    while True:
        ...
        final_move = agent.get_action(state_new)
